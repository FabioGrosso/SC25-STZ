...
int main()
{
    ...
    std::cout << "256^3 (coarse): " << std::fixed << std::setprecision(5)
              << sz_time_taken_decompress << " sec" << std::endl;
    std::cout << "512^3 (mid): " << std::fixed << std::setprecision(5)
              << sz_time_taken_decompress + low_time_taken_decompress + time_taken_reconstructed_low << " sec" << std::endl;
    std::cout << "1024^3 (full): " << std::fixed << std::setprecision(5)
              << sz_time_taken_decompress + low_time_taken_decompress + time_taken_reconstructed_low + time_taken_decompress + time_taken_reconstructed_full << " sec" << std::endl;
